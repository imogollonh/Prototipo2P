...
namespace Capa_Diseño.Mantenimientos
{
    public partial class MantenimientoLineas : Form
    {
        ...
        string scampo;
        string sTabla = "lineas";      //Aqui iria el nombre de la tabla a la cual se le hara el mantenimiento
        string sLlave = "codigo_linea";      //Aqui iria el nombre de la llave primaria de la tabla
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] campos = { "codigo_linea", "nombre_linea", "estado" }; //CAMPOS DE LA TABLA
        ...
        {
            VistaLinea vista = new VistaLinea();
            vista.ShowDialog();
